...
//                         <button className="filters__button--items button is-checked" data-filter="*">Show All</button>
//                         <button className="filters__button--items button" data-filter=".web">Web</button>
//                         <button className="filters__button--items button" data-filter=".graphics">Graphics</button>
//                         <button className="filters__button--items button" data-filter=".development">Development</button>
//                         <button className="filters__button--items button" data-filter=".mobile">Mobile</button>
//                     </div>
//                     <div className="portfolio__grid mb--n30">
//                         <div className="element-item web" data-category="web">
//                             <div className="portfolio__card">
//                                 <a href="#" className="popup-modal--open display-block" data-bs-toggle="modal" data-bs-target="#portfolioModal">
...
//                                         </span>
//                                         <h3 className="portfolio__title text-white">Illustration</h3>
//                                         <p className="portfolio__desc text-white">Promote your blog posts, case udie, and thehe branded videos.</p>
//                                     </div>
//                                 </a>
//                             </div>
//                         </div>
...
//                             </div>
//                         </div>
//                         <div className="element-item development" data-category="development">
//                             <div className="portfolio__card">
//                                 <a href="#" className="popup-modal--open display-block" data-bs-toggle="modal" data-bs-target="#portfolioModal">
//                                     <div className="portfolio__image--card">
